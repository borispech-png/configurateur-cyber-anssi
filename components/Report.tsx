                                      ...
                                      <div className={`mt-6 p-4 rounded-lg border-l-4 print-break-avoid ${maturity >= benchmark.avgMaturity ? 'bg-green-50 dark:bg-green-900/30 border-green-500' : 'bg-orange-50 dark:bg-orange-900/30 border-orange-500'}`}>
                                          ...
                                          <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                                              {maturity >= benchmark.avgMaturity
                                                  ? <span>Bravo, votre maturité est supérieure de <strong>{maturity - benchmark.avgMaturity} points</strong> à la moyenne du secteur ({benchmark.avgMaturity}%<sup>*</sup>).</span>
                                                  : <span>Attention, votre maturité est inférieure de <strong>{benchmark.avgMaturity - maturity} points</strong> à la moyenne du secteur ({benchmark.avgMaturity}%<sup>*</sup>).</span>
                                              }
                                              <br/>
